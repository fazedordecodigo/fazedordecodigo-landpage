...
- `css/sections.css` - Page-section styles (hero, encontros, steps, materiais, parceiros, faq, contato, cta)
- `assets/` - Static assets (`logo.svg`, `hero-capivara.webp`, partner logos `hostgator.webp`, `fiap.svg`)
